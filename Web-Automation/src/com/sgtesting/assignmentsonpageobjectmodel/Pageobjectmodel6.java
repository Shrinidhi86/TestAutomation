...
public class Pageobjectmodel6 {
	...
	static void Createcustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oPage.getCustomernameField().sendKeys("user23");
			Thread.sleep(1000);
	...
	static void CreateProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.writeprojectnamefield().sendKeys("Stage2establishment");
			Thread.sleep(2000);
	...
	static void modifyproject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.projectmodify().sendKeys("underprocess");
			Thread.sleep(2000);
			oPage.projectclosebutton().click();
			Thread.sleep(2000);
