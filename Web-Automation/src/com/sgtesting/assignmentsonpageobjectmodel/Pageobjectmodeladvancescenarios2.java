...
public class Pageobjectmodeladvancescenarios2 {
	...
	static void userbutton()
	{
		try
		{
			oPage.clickonuserButton().click();
		}catch(Exception e)
		{
			e.printStackTrace();
		}
	...
	static void demo33deletebutton()
	{
		try
		{
			oPage.demo33deletebutton().click();
			Thread.sleep(1000);
	...
	static void demo22deletebutton()
	{
		try
		{
			oPage.demo22deletebutton().click();
			Thread.sleep(1000);
	...
	static void demo11deletebutton()
	{
		try
		{
			oPage.demo11deletebutton().click();
			Thread.sleep(1000);
