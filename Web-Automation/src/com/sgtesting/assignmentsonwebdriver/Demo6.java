...
public class Demo6 {
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Johnson&johnson21");
			Thread.sleep(2000);
	...
	static void createProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("projectPopup_projectNameField")).sendKeys("EscalatorDemo");
			Thread.sleep(2000);
	...
	static void modifyproject()
{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("Projectfinal");
			Thread.sleep(2000);
