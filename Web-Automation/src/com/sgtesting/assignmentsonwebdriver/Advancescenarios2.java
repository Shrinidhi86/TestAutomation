...
public class Advancescenarios2 {
	...
	static void modifyPassWordUser3()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.name("password")).sendKeys("user369");
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("user369");
			oBrowser.findElement(By.xpath("//*[@id=\"userDataLightBox_commitBtn\"]/div/span")).click();
			Thread.sleep(3000);
		}catch(Exception e)
		{
	...
	static void loginUser33()
	{
		...
		{
			oBrowser.findElement(By.name("username")).sendKeys("user3");
			oBrowser.findElement(By.name("pwd")).sendKeys("user369");
			oBrowser.findElement(By.xpath("//*[@id=\"loginButton\"]/div")).click();
			Thread.sleep(3000);
		}catch(Exception e)
		{
